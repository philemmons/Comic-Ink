...
<main id="main-content">
  <article aria-label="Influential and favorite covers">
    <div class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-sm-8 p-3 bg-body-tertiary text-white">
          <section>
  ...
  <article aria-label="Important because">
    <div class="container mt-5">
      <div class="row justify-content-center mb-5">
        <div class="col-sm-4 p-3 bg-body-tertiary text-white mb-5">
          <p>These comics are significant not only for their storytelling and artistic achievements but also for their impact on the comic book industry and popular culture. They have inspired countless adaptations in film, television, and other media, and continue to influence new generations of creators and readers.</p>
        </div>
        ...
        <div class="col-sm-4 p-3 bg-body-tertiary text-white">
          <section>
            <h2 class="h6">The most significant comic mediums span a variety of genres, styles, and historical periods, each marking a pivotal moment in the medium's development. Below are thirteen covers of the most influential and some personal favorites.</h2>
          </section>
        </div>
